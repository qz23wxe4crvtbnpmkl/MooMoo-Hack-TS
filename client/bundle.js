        ...
        if (_Players_PlayerManager__WEBPACK_IMPORTED_MODULE_0__.Players.myPlayer) {
            if (Game.canvas) {
                if (!this.ctx) {
                    ...
                    M.fill();
                    M.arc(Game.playerXY.x - Game.xOffset, Game.playerXY.y - Game.yOffset, 90, 0, _Math__WEBPACK_IMPORTED_MODULE_7__.PI * 2);
                    M.fill();
                }
            }
        }
