 ...
 * Imports
 */
var FindPlayerBySID_1 = require("../UTILS/FindPlayerBySID"); // Import function to find a player by their session ID
var updatePlayer_1 = require("./updatePlayer"); // Import function to update a player's information
/**
...
var Players = /** @class */ (function () {
    ...
    Players.prototype.updatePlayers = function (data) {
        ...
        for (var i = 0; i < data.length; i += 13) {
            var tmpPlayer = (0, FindPlayerBySID_1.findPlayerBySid)(data[0]);
            if (tmpPlayer) {
                (0, updatePlayer_1.updatePlayer)(tmpPlayer, data, i);
            }
        }
    };
    return Players;
