 ...
 */
export function getDistance(obj1, obj2, obj1type, obj2type) {
    /**
     ...
     */
    return hypot(obj1["x".concat(obj1type || "")] - obj2["x".concat(obj2type || "")], obj1["y".concat(obj1type || "")] - obj2["y".concat(obj2type || "")]);
}
